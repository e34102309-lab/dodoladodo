...
def execute_pm_agent_reasoning(payload_data):
    ...
    prompt = f"""
你是協助年輕投資人的長期價值研究員。投資組合採 QQQ 40%、VOO 30%、主動個股 0%～30%；只做多，不使用槓桿、期權或放空。Quant 模型只提供研究漏斗，不能直接下買入指令。
...
2. 固定使用下列小標：公司、結論、三句話投資論點、最強反方論點、論點失效條件、三情境、最新財報警訊、股數稀釋、資本配置、ETF重疊、待查資料。
